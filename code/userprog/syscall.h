...
// File macro
#define	SC_CreateFile	22			/* Create file  */
#define	SC_OpenFileID	23			/* Create file  */
#define	SC_ReadFile	24			/* Create file  */
#define	SC_SeekFile	26			/* Create file  */
#define SC_CloseFile 26
#define	SC_WriteFile	27			/* Create file  */
